...
const reFont = /\.(eot|woff|woff2|ttf|svg)$/i;
    ...
    rules: [
      // Rules for JS / JSX
      {
        ...
        options: {
          ...
          plugins: [
            ...babelCfg.plugins,
            ['babel-plugin-styled-components', { displayName: isDebug }],
            ...(isDebug
              ? []
              : [
      ...
      // Rules for Style Sheets
      {
        test: reStyle,
        rules: [
          // Convert CSS into js module with string
          {
      ...
      {
        exclude: [reFont, reScript, reStyle, reImage, /\.json$/, /\.txt$/, /\.md$/],
        loader: 'file-loader',
        options: {
          publicPath,
          outputPath: 'public/assets',
